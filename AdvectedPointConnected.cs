    ...
    : AdvectedPoint(vCalc)
{
    ...
    */
    protected AdvectedPointConnected? Previous;
    protected AdvectedPointConnected? Next;
    protected ConnectedSegment? Segment;
    // Cleanup allows callbacks - it will be called with this point as an argument when the point is deactivated
    protected Action<AdvectedPointConnected>? Cleanup;
    ...
    public void Connect(AdvectedPointConnected? predecessor, uint? segmentID = null, string segmentSource = "UNKNOWN", Action<AdvectedPointConnected>? cleanup=null)
    {
    ...
    public void CreateSegment(uint uniqueID, string source)
    {
        ...
        Segment = new ConnectedSegment(this,Previous,uniqueID,source);
    }
