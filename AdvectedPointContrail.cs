...
public class AdvectedPointContrail : AdvectedPointConnected
{
    ...
    public override bool CheckValid()
    {
        ...
        return base.CheckValid() || (IsLeader || ContrailLive() || (Next != null && ((AdvectedPointContrail)Next).ContrailLive()));
    }
