...
public class PointManagerDense : PointManager
{
    ...
    public PointManagerDense( DomainManager domain, RunOptions configOptions, LGOptionsPointsDense configSubOptions,
    ...
    {
        AdvectedPointAirMass point = (AdvectedPointAirMass)base.NextPoint(x, y, pressure);
